...
- The query used an index to figure out which documents match the find criteria. **False**
- The query scanned every document in the collection. **True**
- The query returned 120,477 documents. **False**
- The query avoided sorting the documents because it was able to use an index's ordering. **True**
